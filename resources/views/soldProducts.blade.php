...
<div id="wrapper">
    ...
    @if(Session::has('success'))
       ...
       <h3 style="text-align:center; font-size:50px;">Art Pieces that you have sold</h3>
...
@if($data->count() > 0)
   ...
   <p style="color:#666; font-size:20px;"> Created At : <span style="color:purple; font-size:20px;">{{$products->start_date}}</span> </p>
